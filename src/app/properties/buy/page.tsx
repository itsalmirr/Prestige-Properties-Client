...
// const FindYourHome = async () => {
//   const res = await axios.get('http://localhost:8080/api/v1/properties/buy')
...
//                 {listing.title}
//               </h3>
//               <p className='text-base/7 text-gray-600'>{listing.address}</p>
